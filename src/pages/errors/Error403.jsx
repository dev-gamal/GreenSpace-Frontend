...
import { Lock, Key, Compass, Users, Inbox, ShieldCheck, Mail, Map } from 'lucide-react';
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[80vh] px-4 py-12 text-center">
      ...
      <p className="max-w-2xl mb-10 text-lg text-gray-500">
        Vous tentez d'entrer dans une parcelle agricole privative, un contrat de co-jardinage restreint ou un carnet de culture réservé aux membres accrédités de GreenSpace.
      </p>
      ...
      <div className="flex flex-wrap justify-center gap-4 mb-16">
        ...
        <Button asChild variant="secondary" className="gap-2 px-8 py-6 text-gray-800 bg-gray-100 rounded-full hover:bg-gray-200">
          <Link to="/explore">
        ...
        <Card className="shadow-sm border-gray-100 hover:shadow-md transition-shadow">
          <CardContent className="p-6">
            <div className="flex items-start gap-4 mb-4">
              ...
              <div>
                <h3 className="font-bold text-gray-900">Jardinier bénévole ?</h3>
                <p className="text-xs text-gray-500 uppercase tracking-wide font-semibold mt-1">Statut invité</p>
              </div>
            </div>
            <p className="text-sm text-gray-600 mb-6">
              Si un maraîcher ou un propriétaire vous a confié une clé numérique de parcelle, vérifiez l'invitation dans vos notifications.
            </p>
            <Link to="/messages" className="text-sm font-bold text-green-700 hover:text-green-800 flex items-center gap-1">
        ...
        <Card className="shadow-sm border-gray-100 hover:shadow-md transition-shadow">
          <CardContent className="p-6">
            <div className="flex items-start gap-4 mb-4">
              ...
              <div>
                <h3 className="font-bold text-gray-900">Propriétaire foncier ?</h3>
                <p className="text-xs text-gray-500 uppercase tracking-wide font-semibold mt-1">Rôle Hôte / Bailleur</p>
              </div>
            </div>
            <p className="text-sm text-gray-600 mb-6">
              Assurez-vous d'être connecté avec votre identifiant cadastral ou le compte certifié gérant ce terrain.
            </p>
            <Link to="/dashboard" className="text-sm font-bold text-gray-600 hover:text-gray-900 flex items-center gap-1">
        ...
        <Card className="shadow-sm border-gray-100 hover:shadow-md transition-shadow">
          <CardContent className="p-6">
            <div className="flex items-start gap-4 mb-4">
              ...
              <div>
                <h3 className="font-bold text-gray-900">Assistance GreenSpace</h3>
                <p className="text-xs text-gray-500 uppercase tracking-wide font-semibold mt-1">Garde-champêtre 24/7</p>
              </div>
            </div>
            <p className="text-sm text-gray-600 mb-6">
              Un dysfonctionnement de bail ou un lien brisé ? Notre équipe de médiateurs communautaires vous répond rapidement.
            </p>
            <a href="#" className="text-sm font-bold text-green-700 hover:text-green-800 flex items-center gap-1">
      ...
      <div className="w-full max-w-5xl p-6 bg-gray-50 rounded-3xl flex flex-col md:flex-row items-center justify-between text-left gap-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h4 className="font-bold text-gray-900 mb-1">Vous cherchez de la terre libre à cultiver ?</h4>
            <p className="text-sm text-gray-500">Plus de 1 200 parcelles urbaines, balcons partagés et vergers collectifs sont ouverts sans restriction de badge dans votre périmètre.</p>
          </div>
        </div>
        <Button asChild variant="outline" className="bg-white border-gray-200 text-gray-900 hover:bg-gray-50 shrink-0 px-6 py-6 rounded-full font-semibold shadow-sm">
          <Link to="/explore">
